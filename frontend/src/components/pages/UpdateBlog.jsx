    ...
    const fetchBlog = async () => {
      try {
        const { data } = await axios.get(
          `https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/blog/singleblog/${id}`,
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const { data } = await axios.put(
        `https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/blog/update/${id}`,
        updatedBlog,
        { withCredentials: true }
      );
