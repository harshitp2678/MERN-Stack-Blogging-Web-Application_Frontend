...
const MyBlogs = () => {
  ...
  useEffect(() => {
    const fetchMyBlogs = async () => {
      const { data } = await axios.get(
        "https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/blog/myblogs",
  ...
  const deleteBlogHandler = async (id) => {
    await axios
      .delete(`https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/blog/delete/${id}`, {
        withCredentials: true,
      })
      .then((res) => {
