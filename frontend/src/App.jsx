...
const App = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const { data } = await axios.get(
          "https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/user/myprofile",
          { 
    ...
    const fetchBlogs = async () => {
      try {
        const { data } = await axios.get(
          "https://mern-stack-blogging-web-application-r8me.onrender.com/api/v1/blog/all",
          { withCredentials: true }
        );
